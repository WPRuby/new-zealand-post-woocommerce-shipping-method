	...
	<table class="form-table">
		<tbody>
			<tr class="form-field form-required">
				...
				<p class="description"><?php _e('Unfortunately, WordPress does not allow the changing of usernames', 'controlled-admin-access'); ?> <?php _e('Unfortunately, WordPress does not allow the changing of usernames', 'controlled-admin-access'); ?>.</p>
				</td>
			</tr>
			<tr class="form-field form-required">
