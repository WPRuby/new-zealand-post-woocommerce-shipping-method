	...
	<table class="form-table">
		<tbody>
												  ...
												  <li>
												    ...
												    <?php if(isset($item['sub_items'] )): ?>
															...
															<?php foreach($item['sub_items'] as $sub_item): ?>
															      <li>
															        <input type="checkbox" name="sub_items[]" value="<?php echo $sub_item[2]; ?>" id="<?php echo $sub_item[1]; ?>" <?php $this->is_disabled($item['slug']); ?> >
			...
			<tr class="form-field form-required">
				...
				<td>
					<select name="user_expiring" <?php selected($_POST['user_expiring']) ?>>
