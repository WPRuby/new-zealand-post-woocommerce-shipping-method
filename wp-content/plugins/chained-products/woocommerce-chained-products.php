 ...
 * Copyright (c) 2012, 2013, 2014, 2015, 2016 StoreApps All rights reserved.
 * 
...
if ( is_woocommerce_active() ) {
    ...
    add_filter( 'woocommerce_order_get_items', 'sa_cp_ignore_chained_child_items_on_manual_pay', 99, 2 );
	 ...
	 */
	function sa_cp_ignore_chained_child_items_on_manual_pay( $items, $order ) {
		if ( Chained_Products_WC_Compatibility::is_wc_greater_than( '2.0.20' ) && isset( $_GET['pay_for_order'] ) && isset( $_GET['key'] ) && ! empty( $items ) ) {
