...
function wf_ups_basic_pre_activation_check(){
	if ( is_plugin_active('ups-woocommerce-shipping/ups-woocommerce-shipping.php') ){
		...
		wp_die(__("Is everything fine? You already have the Premium version installed in your website. For any issues, kindly raise a ticket via <a target='_blank' href='http://support.wooforce.com/'>support.wooforce.com</a>", "ups-woocommerce-shipping"), "", array('back_link' => 1 ));
	}
}
